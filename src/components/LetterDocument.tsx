...
export const LetterDocument: React.FC<LetterDocumentProps> = ({
  ...
  if (!draft) {
    ...
    return (
      <div className="flex flex-col h-full bg-white rounded-2xl border border-stone-200/80 shadow-xs overflow-hidden p-6 sm:p-8 justify-between">
        <div>
          {/* Header */}
          ...
          {currentStage >= 5 && (
            <div className="mt-4 p-4 rounded-xl bg-amber-50/90 border border-amber-200 text-stone-800">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="border border-dashed border-stone-300 rounded-xl p-5 text-center bg-stone-50/40">
              ...
              <p className="text-xs text-stone-500 max-w-sm mx-auto mb-4 leading-relaxed">
                ...
                reason for writing first so the message represents you truthfully without unnecessary
                escalation.
              </p>
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-2xl border border-stone-200/80 shadow-xs overflow-hidden">
      {/* Top Bar */}
      <div className="px-5 py-3.5 bg-stone-50/90 border-b border-stone-200 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center space-x-2.5">
      ...
      {/* Tabs */}
      <div className="px-5 border-b border-stone-200 bg-white flex space-x-6 text-xs font-semibold">
        <button
          type="button"
          ...
          <div className="space-y-4">
            <div className="bg-amber-50/70 border border-amber-200 rounded-xl p-5">
              <h3 className="text-sm font-bold text-amber-950 flex items-center mb-2">
                ...
                How the Recipient May Receive This Message
              </h3>
