Never deploy with Vercel CLI or the Vercel plugin's deploy command. To publish, commit the changes and push them to GitHub. Vercel deploys automatically from GitHub.
